  ...
  return (
    <div className={s.root}>
      ...
      <div className={s.breakdownGrid}>
        ...
        <div className={s.breakdownPanel}>
          {/* RAG Memories */}
          <div style={{ margin: '0 0 12px', padding: '10px 14px', background: 'var(--surface-secondary)', borderRadius: 8, cursor: 'pointer' }} onClick={() => setShowMemories(!showMemories)}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontWeight: 600, fontSize: 14 }}>🧠 结构化记忆 (RAG)</span>
              <span style={{ fontSize: 12, color: 'var(--text-secondary)' }}>{memoryStats.reduce((s:number,r:any)=>s+parseInt(r.cnt),0)} 条</span>
            </div>
