...
/**
 * SettingsPageShell — dense-config page shell for /settings/* routes.
 *
 * Mirrors ChannelsPageShell: optional meta rail + content area on a 12-col
 * grid, no default 8px radius. Chrome uses 4px / 0 radius to keep the
 * "settings center" feel — admin console chrome, not consumer product UI.
 *
 * Intentionally does NOT include a header — that lives in SettingsSubnav
 * which is rendered by the route-group layout.
 */
...
/**
 * SettingsMeta — dense metadata sidebar used on each Settings page.
