...
export default function MemoryPage() {
  ...
  useEffect(() => {
    setLoading(true);
    const url = '/api/v2/admin/knowledge-bases?type=personal';
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">数字员工记忆</h1>
        <p className="text-sm text-muted-foreground">每个 Agent / Bot 私有 KB(per-agent),继承 Agent 配置。Bot 启动时自动加载。</p>
      </div>
