...
export default function MemoryPage() {
  ...
  useEffect(() => {
    setLoading(true);
    const url = '/api/v2/admin/knowledge-bases?type=company';
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">公共记忆</h1>
        <p className="text-sm text-muted-foreground">Company 级 KB,跨 Bot 共享。所有 Agent 启动时自动加载。</p>
      </div>
